...
const LetterGlitch = ({
  glitchColors = ['#4F4E6E', '#5555ff', '#61b3dc'],
  glitchSpeed = 50,
  ...
  return (
    <div className="absolute top-0 left-0 w-full min-h-[100%] z-[-1] overflow-hidden">
      <canvas ref={canvasRef} className="block w-full h-full" />
      {outerVignette && (
        <div
          className="absolute top-0 left-0 w-full h-full pointer-events-none bg-[radial-gradient(circle,_rgba(0,0,0,0)_90%,_rgba(0,0,0,1)_100%)]"
        ></div>
      )}
      {centerVignette && (
        <div
